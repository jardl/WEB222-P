...
!(function(e, t) {
  ...
  function p(e) {
    var t = !!e && 'length' in e && e.length,
      n = T(e);
    return (
      !x(e) && !w(e) && ('array' === n || 0 === t || ('number' == typeof t && 0 < t && t - 1 in e))
    );
  }
  (E.fn = E.prototype = {
    jquery: f,
      ...
      return (
        r !== T &&
          ...
          (p.getById = ce(function(e) {
            return (
              (a.appendChild(e).id = N), !T.getElementsByName || !T.getElementsByName(N).length
            );
          })),
          p.getById
                ...
                if (c) {
                  ...
                  if (((u = [m ? c.firstChild : c.lastChild]), m && d)) {
                    (p =
                      (s =
                        (r =
                          (i = (o = (a = c)[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[
                            h
                          ] || [])[0] === A && r[1]) && r[2]),
                      (a = s && c.childNodes[s]);
                    ...
                    (d &&
                      (p = s =
                        (r =
                          (i = (o = (a = e)[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[
                            h
                          ] || [])[0] === A && r[1]),
                    !1 === p)
                  )
                    while ((a = (++s && a && a[l]) || (p = s = 0) || u.pop()))
                      if (
                        ...
                        ++p &&
                        (d &&
                          ((i = (o = a[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[
                            h
                          ] = [A, p]),
                        a === e)
                      )
                        ...
                        (t = e && ('object' == typeof e || 'function' == typeof e) && e.then),
                          x(t)
                            ? s
                              ...
                              : (u++,
                                t.call(e, l(u, o, R, s), l(u, o, B, s), l(u, o, R, o.notifyWith)))
                      ...
                      : function() {
                          try {
                            ...
                            E.Deferred.exceptionHook && E.Deferred.exceptionHook(e, t.stackTrace),
                              u <= i + 1 &&
                                (a !== B && ((n = void 0), (r = [e])), o.rejectWith(n, r));
                          }
                        };
                  i
                    ? t()
        ...
        while ((i = a[t++]) && !s.isPropagationStopped()) {
          ...
          while ((o = i.handlers[n++]) && !s.isImmediatePropagationStopped())
            (s.rnamespace && !1 !== o.namespace && !s.rnamespace.test(o.namespace)) ||
              ...
              (s.data = o.data),
              void 0 !==
                (r = ((E.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, u)) &&
                !1 === (s.result = r) &&
